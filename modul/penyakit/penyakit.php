  ...
  switch ($_GET[act]) {
    ...
    case "tambahpenyakit":
      echo "<form name=text_form method=POST action='$aksi?module=penyakit&act=input' onsubmit='return Blank_TextField_Validator()' enctype='multipart/form-data'>
		  ...
		  <tr><td width=120>Detail Penyakit</td><td> <textarea rows='4' cols='50' class='form-control' name='definisi'type=text placeholder='Masukkan detail penyakit baru...'></textarea></td></tr>
		  <tr><td width=120>Saran Pengobatan</td><td><textarea rows='4' cols='50' class='form-control' name='solusi'type=text placeholder='Masukkan saran pengobatan penyakit baru...'></textarea></td></tr>		  
    ...
    case "editpenyakit":
      ...
      echo "<form name=text_form method=POST action='$aksi?module=penyakit&act=update' onsubmit='return Blank_TextField_Validator()' enctype='multipart/form-data'>
		  ...
		  <tr><td width=120>Detail Penyakit</td><td><textarea rows='4' cols='50' type=text class='form-control' name='definisi'>$r[definisi]</textarea></td></tr>
		  <tr><td width=120>Saran Pengobatan</td><td><textarea rows='4' cols='50' type=text class='form-control' name='solusi'>$r[solusi]</textarea></td></tr>         
          <tr><td></td><td><input class='btn btn-success' type=submit name=submit value='Simpan' >
		  <input class='btn btn-danger' type=button name=batal value='Batal' onclick=\"window.location.href='?module=penyakit';\"></td></tr>
          </table></form>";
      break;
