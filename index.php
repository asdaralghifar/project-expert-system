...
<html><head>
    ...
    <base href="http://localhost/sispalit/">
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-mini"><b><i class="fa fa-contao" aria-hidden="true"></i> </b></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b><i class="fa fa-contao" aria-hidden="true"></i>  SISPALIT</b></span>
        </a>
        <!-- Header Navbar -->
        <nav class="navbar navbar-static-top" role="navigation">
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                if (isset($_SESSION['username']) && isset($_SESSION['password'])) {
                  ...
                  <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                      <img src="gambar/admin/sp.png" class="user-image" alt="User Image"> <?php echo ucfirst($_SESSION['username']); ?>
                      <span class="hidden-xs"><?php echo $user; ?></span>
                    </a>
                    <ul class="dropdown-menu">
                      <!-- User image -->
                      <li class="user-header">
                        <img src="gambar/admin/sp.png" class="img-circle" alt="User Image">
                        <p>
                      ...
                      <li class="user-footer"> 
                        <!-- <div class="pull-left">
                          <a class="btn btn-default btn-flat" <php if ($module == "tentang") echo 'class="class="btn btn-default btn-flat active"'; ?> href="tentang"><i class="fa fa-info-circle"></i> <span></span></a>
                        </div> -->
              ...
              <?php } else { ?> <li><a <?php if ($module == "bantuan") echo 'class="active"'; ?> id="bantu" href="bantuan" data-toggle="tooltip" data-placement="bottom" data-delay='{"show":"300", "hide":"500"}' title="Silahkan klik link berikut, jika anda masih kurang paham tentang penggunaan aplikasi ini !"> <span>
...
function kirimContactForm(){
    ...
    if(nama.trim() == '' ){
        ...
        <strong><div class="cinta">©2022 - Developed with <i class="fa fa-heart pulse"></i> by <a href="https://www.instagram.com/asdar.alghifar/" target="_blank">Tororo</a></div></strong>
      </footer>
